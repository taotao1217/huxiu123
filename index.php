...
foreach ($huxiu_information_flow->find('div[data-v-674667a5 data-v-7009b653]') as $aitem); 
foreach ($aitem->find('div[data-v-674667a5 class="article-item"]') as $item); 
echo $item;
...
/*
{
   ...
   # $other_notes = $tag->plaintext;
    ...
    echo $article_url . ' scraping finished.<br>';
/*
